...
namespace CaseDocumentExtractJob
{
  internal class DataProcessor : TaskProcessor
  {
    ...
    public override void Run()
    {
      ...
      try
      {
        ...
        foreach (var document in result.Documents) {
          GetDocument(document.CurrentDocumentVersionID);
        }
    ...
    private GetDocumentInfoByEntityResultEntity GetDocumentInfo(string caseID)
    {
      ...
      entity.SetStandardAttributes(int.Parse("200"), "GetDocumentInfoByEntity", Context.UserID, "GetDocumentInfoByEntity", Context.SiteID);
      entity.UserID = "1";
